...
function TodoList() {
  ...
  useEffect(() => {
    const getItemList = async () => {
      try {
        ...
        const res = await axios.get(`https://luanle.gcalls.vn:5050/api/items/${id}`);
  ...
  const addItem = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(`https://luanle.gcalls.vn:5050/api/item/${id}`, {
        item: itemText,
      });
  ...
  const deleteItem = async (id) => {
    try {
      await axios.delete(`https://luanle.gcalls.vn:5050/api/item/${id}`);
  ...
  const updateItem = async (e) => {
    ...
    try {
      ...
      const res = await axios.put(
        `https://luanle.gcalls.vn:5050/api/item/${isUpdating}`,
        { item: itemTextUpdate }
      );
  ...
  const toggleCompletion = async (id, isCompleted) => {
    try {
      const res = await axios.put(
        `https://luanle.gcalls.vn:5050/api/item/status/${id}`,
